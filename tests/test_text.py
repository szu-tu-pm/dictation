...
def test_ghosts() -> None:
    ...
    assert is_ghost("thank you for watching")
    assert is_ghost("please subscribe")
    assert is_ghost("Subtitles by the Amara.org")
    assert is_ghost("   ")
    assert is_ghost(".")


def test_not_ghosts() -> None:
    assert not is_ghost("thank you")
    assert not is_ghost("thanks")
    assert not is_ghost("you")
    assert not is_ghost("the")
