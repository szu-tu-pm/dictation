...
| `tests/test_app_tray.py` | Tray Continuous Mode / mute / device / Recent Transcripts wiring; history recorded before paste failure |
...
3. **Pass:** paste fails or does nothing. This is expected UIPI. Tray shows `Paste failed — use Recent Transcripts`.
